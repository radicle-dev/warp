...
use super::header;
use crate::document::{DocumentedCookie, DocumentedFilter, DocumentedResponse, ExplicitDocumentation};
...
pub fn cookie(name: &'static str) -> impl Filter<Extract = One<String>, Error = Rejection> + DocumentedFilter + Copy {
...
pub fn optional(
    name: &'static str,
) -> impl Filter<Extract = One<Option<String>>, Error = Infallible> + DocumentedFilter + Copy {
